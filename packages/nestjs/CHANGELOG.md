...
- 03f60d5: Fixed an issue where `tenantId` was not properly forwarded in `QueryModelProjectionConsumerService`
...
- 25cd807: Added in-memory adapters for repository and transaction manager ports
