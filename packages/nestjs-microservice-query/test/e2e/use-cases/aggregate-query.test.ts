...
describe("aggregate query behavior", () => {
    ...
    describe("when listing aggregate types", () => {
        it("returns available aggregate types", async () => {
    ...
    describe("when listing aggregate ids", () => {
        it("returns all aggregate ids for a given aggregate type", async () => {
    ...
    describe("when rebuilding an aggregate", () => {
        it("returns an aggregate by id", async () => {
            const userManager = eventSourcingService.createAggregateContext(null, User);
        ...
        it("returns null when the aggregate does not exist", async () => {
    ...
    describe("when reading aggregate events", () => {
        it("returns events for an aggregate", async () => {
            const userManager = eventSourcingService.createAggregateContext(null, User);
        ...
        it("returns an empty array when the aggregate does not exist", async () => {
