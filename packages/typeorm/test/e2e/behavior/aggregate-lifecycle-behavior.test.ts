...
describe("aggregate lifecycle behavior", () => {
    ...
    describe("when committing aggregate creation", () => {
        it("should persist and publish the creation event", async () => {
            const user = new User();
    ...
    describe("when mutating an existing aggregate", () => {
        ...
        it("should rebuild from history, apply mutation, and persist a new event", async () => {
        ...
        it("should create a snapshot after crossing the snapshot interval", async () => {
            const user = await userFactory.build(userId);
        ...
        it("should restore from snapshot and allow new mutations", async () => {
            const user = await userFactory.build(userId);
        ...
        it("should support additional commands after snapshot restore", async () => {
            const user = await userFactory.build(userId);
