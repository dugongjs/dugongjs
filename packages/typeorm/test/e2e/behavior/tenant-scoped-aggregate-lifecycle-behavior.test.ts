...
describe("tenant-scoped aggregate lifecycle behavior", () => {
    ...
    describe("when committing aggregate creation", () => {
        it("should persist and publish a tenant-scoped creation event", async () => {
            const user = new User();
        ...
        it("should apply staged events to aggregate state", async () => {
            const user = new User();
    ...
    describe("when mutating an existing aggregate", () => {
        ...
        it("should rebuild from tenant-scoped history, apply mutation, and persist a new event", async () => {
        ...
        it("should create a tenant-scoped snapshot after crossing the snapshot interval", async () => {
            const user = await userFactory.build(userId);
        ...
        it("should restore from tenant-scoped snapshot and allow new mutations", async () => {
            const user = await userFactory.build(userId);
        ...
        it("should support additional commands after tenant-scoped snapshot restore", async () => {
            const user = await userFactory.build(userId);
    ...
    describe("when deleting an aggregate", () => {
        ...
        it("should mark the aggregate as deleted", async () => {
            const user = await userFactory.build(userId);
        ...
        it("should return null when rebuilding a deleted aggregate by default", async () => {
            const user = await userFactory.build(userId);
        ...
        it("should return deleted aggregate when returnDeleted is enabled", async () => {
            const user = await userFactory.build(userId);
