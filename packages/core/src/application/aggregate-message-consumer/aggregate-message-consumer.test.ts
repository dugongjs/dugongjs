...
import type { IMessageExtractor } from "../../ports/inbound/message-broker/i-message-extractor.js";
...
describe("AggregateMessageConsumer", () => {
    ...
    const mockMessageExtractor = mock<IMessageExtractor<any>>();
    ...
    beforeEach(() => {
        ...
        mockReset(mockMessageExtractor);
    ...
    const options: AggregateMessageConsumerOptions<any, any> = {
        ...
        messageExtractor: mockMessageExtractor,
        logger: mockLogger,
    ...
    it("should register a message consumer and process messages", async () => {
        ...
        mockMessageExtractor.extractSerializedDomainEventFromMessage.mockReturnValue(serializedDomainEvent);
        ...
        expect(mockMessageExtractor.extractSerializedDomainEventFromMessage).toHaveBeenCalledWith(mockMessage);
